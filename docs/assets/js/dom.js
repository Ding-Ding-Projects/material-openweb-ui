	...
	for (const [k, v] of Object.entries(props || {})) {
		...
		// setAttribute the way they appear to.
			...
			throw new Error(
				'h(): "' +
					k +
					'" was given a function. Handlers are on* names; use ref or props for anything else.'
			);
...
const PATHS = {
	...
	shield:
		'<path d="M12 3.5 5 6.5v5c0 4.2 2.9 7.6 7 9 4.1-1.4 7-4.8 7-9v-5z"/><path d="m9.3 12 1.9 1.9 3.6-3.7"/>',
	server:
		'<rect x="3" y="4" width="18" height="7" rx="2.2"/><rect x="3" y="13" width="18" height="7" rx="2.2"/><path d="M7 7.5h.01M7 16.5h.01"/>',
	swap: '<path d="M4 8.5h11l-3-3"/><path d="M20 15.5H9l3 3"/>',
	undo: '<path d="M4 10h10a5 5 0 0 1 0 10H9"/><path d="M4 10l4-4M4 10l4 4"/>',
	phonelock:
		'<rect x="6.5" y="2.5" width="11" height="19" rx="2.6"/><path d="M10.5 17.5h3"/><path d="M9.5 7.5h5M9.5 11h5"/>',
	...
	github:
		'<path d="M9 19.5c-4 1.2-4-2.2-5.5-2.7M15 21v-3.2a2.8 2.8 0 0 0-.8-2.2c2.7-.3 5.4-1.3 5.4-5.9a4.6 4.6 0 0 0-1.2-3.2 4.3 4.3 0 0 0-.1-3.2s-1-.3-3.3 1.2a11.4 11.4 0 0 0-6 0C6.7 2.9 5.7 3.3 5.7 3.3a4.3 4.3 0 0 0-.1 3.2 4.6 4.6 0 0 0-1.2 3.2c0 4.6 2.7 5.6 5.4 5.9-.4.4-.7 1-.8 1.7V21"/>',
	...
	unlock:
		'<rect x="4.5" y="10.5" width="15" height="9.5" rx="2.4"/><path d="M8 10.5V8a4 4 0 0 1 7.5-2"/><path d="M12 14.5v2"/>',
	desktop: '<rect x="2.5" y="4" width="19" height="13" rx="2.5"/><path d="M8 21h8M12 17v4"/>',
	language:
		'<path d="M4 6h9M8.5 4v2M11 6c0 4-3.5 7.5-7 8.5"/><path d="M6 10.5c1.6 2.4 3.9 4 6.5 4.5"/><path d="m13.5 20 4-9 4 9M15 17.2h5"/>',
	image:
		'<rect x="2.5" y="4.5" width="19" height="13" rx="2.5"/><path d="M8 21h8"/><path d="M12 17.5V21"/><path d="m6.5 14 3-3.2 2.4 2.3 3-3.4 2.6 4.3"/>',
	menu: '<path d="M4 7h16M4 12h16M4 17h16"/>',
	plus: '<path d="M12 5v14M5 12h14"/>',
	trash:
		'<path d="M4.5 7h15M9.5 7V5.5A1.5 1.5 0 0 1 11 4h2a1.5 1.5 0 0 1 1.5 1.5V7"/><path d="M6.5 7l.8 12.1A1.5 1.5 0 0 0 8.8 20.5h6.4a1.5 1.5 0 0 0 1.5-1.4L17.5 7"/>',
	history:
		'<path d="M3.5 12a8.5 8.5 0 1 0 2.6-6.1"/><path d="M3.5 4.5V10h5.5"/><path d="M12 8v4.4l3 1.8"/>',
	bell: '<path d="M6.5 10a5.5 5.5 0 0 1 11 0c0 4 1.5 5.5 1.5 5.5H5S6.5 14 6.5 10z"/><path d="M10 19a2.2 2.2 0 0 0 4 0"/>',
	palette:
		'<path d="M12 3.5a8.5 8.5 0 0 0 0 17c1.2 0 1.8-.8 1.8-1.7 0-.5-.2-.9-.5-1.2-.3-.4-.5-.7-.5-1.2 0-.9.7-1.6 1.7-1.6h1.2a4.8 4.8 0 0 0 4.8-4.8c0-3.6-3.7-6.5-8.5-6.5z"/><circle cx="7.8" cy="11.2" r="1.1"/><circle cx="10.4" cy="7.6" r="1.1"/><circle cx="14.6" cy="7.9" r="1.1"/>',
