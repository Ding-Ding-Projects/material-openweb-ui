...
const S = {
	...
	// ---- home ----
	'home.eyebrow': {
		en: 'Open WebUI, rebuilt in Material 3',
		zh: 'Open WebUI，用 Material 3 重新做過'
	},
	'home.h1': {
	...
	'home.download.off': {
		en: 'Download for Windows — unavailable until the first release',
		zh: '下載 Windows 版 — 未有第一個 release 之前用唔到'
	},
	...
	'rx.engine': {
		en: 'Engine: JavaScript RegExp, evaluated in this browser. Patterns and sample text are never sent anywhere.',
		zh: '引擎：JavaScript RegExp，喺你部瀏覽器度計。Pattern 同樣本文字唔會傳去任何地方。'
	},

	'palette.placeholder': {
		en: 'Search every page, setting and action…',
		zh: '搵每一頁、每個設定、每個動作…'
	},
