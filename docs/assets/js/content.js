...
export const FEATURES = [
	{
		id: 'md3',
		name: 'Material Design 3 throughout',
		group: 'Interface',
		icon: 'palette',
		site: 'shipped',
		app: 'shipped',
		blurb:
			'Tokens, typography, shape, elevation and motion follow the Material 3 baseline scheme seeded at #6750A4, with no legacy elements left over from the original interface.',
		detail:
		...
		verify:
			'Switch the theme on this page and confirm every surface, border and shadow changes together. Search the stylesheet for a literal hex value outside tokens.css; there should be none.'
	},
	{
		id: 'frameless',
		name: 'Frameless window and custom title bar',
		group: 'Interface',
		icon: 'desktop',
		site: 'na',
		app: 'shipped',
		blurb:
			"The desktop application draws its own title bar and window controls rather than showing the operating system's default chrome.",
		detail:
			'Minimise, maximise and close are real controls wired to the main process over IPC. A web page has no window to manage, so this row is not applicable to the site rather than quietly counted as satisfied.',
		verify:
			'In the built application, each control performs its action, and the window can still be moved and resized by its edges.'
	},
	{
		id: 'tabs',
		name: 'Browser-style tabs',
		group: 'Navigation',
		icon: 'grid',
		site: 'shipped',
		app: 'shipped',
		blurb:
			'Content is separated into tabs you open, pin, reorder, group and close, rather than one long scrolling page.',
		detail:
		...
		verify:
			'Open several tabs, pin one, reload the page, and confirm order and pinned state survive. Narrow the window to phone width and confirm the strip scrolls rather than wrapping.'
	},
	{
		id: 'tabsearch',
		name: 'Four tab-discovery searches',
		group: 'Navigation',
		icon: 'search',
		site: 'na',
		app: 'shipped',
		blurb:
			'A search for the current strip, one inside each group, one for groups by name, and a master search across every open tab.',
		detail:
			'Each has its own anchored regex builder and its own query, pattern, flags and mode. None of them shares hidden state with another, so a pattern typed in one can never silently apply in another.',
		verify: 'Type a pattern into the strip search and confirm the group search is unaffected.'
	},
	{
		id: 'palette',
		name: 'Command palette on Ctrl+Shift+F',
		group: 'Navigation',
		icon: 'search',
		site: 'shipped',
		app: 'shipped',
		blurb:
			'One shortcut reaches every page, every setting and every action, and lands on the exact control rather than the general area.',
		detail:
		...
		verify:
			'Press Ctrl+Shift+F, search for a setting by name, change it from the palette row, then open Settings and confirm it holds.'
	},
	{
		id: 'regex',
		name: 'A regex builder beside every search field',
		group: 'Search',
		icon: 'search',
		site: 'shipped',
		app: 'shipped',
		blurb:
			'Every search field, every dropdown filter and every right-click menu filter carries its own anchored pattern builder.',
		detail:
		...
		verify:
			'Open any menu on this site, press the .* button in its filter, build a pattern, apply it, and confirm only that menu filters.'
	},
	{
		id: 'chat',
		name: 'Chat with a local model',
		group: 'Models',
		icon: 'chat',
		site: 'na',
		app: 'shipped',
		blurb:
			'Streamed replies from a model running on this machine, with a model picker, cancellation and honest empty states.',
		detail:
		...
		verify:
			'Stop the Ollama daemon and confirm the page diagnoses that rather than replying. Press Stop mid-reply and confirm the partial text is kept and marked as stopped.'
	},
	{
		id: 'ollama',
		...
		app: 'shipped',
		blurb:
			'Daemon health, installed models, the full published catalog with every tag, pulls with real progress, deletes behind the confirmation gate, and a chat surface.',
		detail:
		...
		verify:
			'With the daemon stopped, the surface diagnoses that exact state and offers a retry, rather than spinning. Confirm the catalogue states where it fetches from before the request, and that its completeness verdict names what it is based on.'
	},
	{
		id: 'fit',
		name: 'Evidence-backed hardware fit verdicts',
		group: 'Models',
		icon: 'pulse',
		site: 'na',
		app: 'shipped',
		blurb:
			'Every model variant is rated Runs well, Runs with limits, Unlikely, or Unknown, from measured hardware rather than from its name.',
		detail:
		...
		verify:
			'Change the destination drive to one with less free space and confirm affected verdicts recompute and say why.'
	},
	{
		id: 'converter',
		...
		app: 'shipped',
		blurb:
			'Type detected from the actual bytes, eight adapter categories, and every unavailable format listed with the exact dependency it is missing.',
		detail:
		...
		verify:
			'Rename a PNG to .txt and confirm it is still detected as an image; check that a disabled row names its missing dependency rather than simply being greyed out.'
	},
	{
		id: 'authenticator',
		...
		app: 'shipped',
		blurb:
			'Standards-correct one-time codes for whatever accounts you like, computed locally and checked against the published test vectors.',
		detail:
		...
		verify:
			'Run the RFC 6238 published test vectors; every one must match. Set the system clock forward and confirm the surface says so.'
	},
	{
		id: 'qr',
		name: 'QR pairing for one-time-code registration',
		group: 'Tools',
		icon: 'phonelock',
		site: 'na',
		app: 'shipped',
		...
		verify:
			'Confirm no network request occurs anywhere in registration, and that a wrong confirmation code is rejected.'
	},
	{
		id: 'locks',
		name: 'Toy locks on every element',
		group: 'Locks',
		icon: 'lock',
		site: 'na',
		app: 'shipped',
		blurb:
			'Any tab, control or appearance value takes its own password or one-time-code lock, each with its own independent credential.',
		detail:
		...
		verify:
			'Lock two elements with different credentials and confirm unlocking one leaves the other locked.'
	},
	{
		id: 'tickets',
		playful: true,
		...
		app: 'shipped',
		blurb:
			'The recovery route for a forgotten lock, dressed as a service desk, whose resolution is the only thing that actually works.',
		detail:
		...
		verify:
			'Confirm the disclosure line is present and unstyled at every funny level, and that no network request is made.'
	},
	{
		id: 'ladder',
		playful: true,
		name: 'The unlock ladder',
		group: 'Locks',
		icon: 'unlock',
		site: 'na',
		app: 'shipped',
		blurb:
			'Locked out? Play your way through dim sum, then sums, then whack-a-mole — or serve the clock.',
		detail:
		...
		verify:
			'Confirm a cleared ladder sets no session and leaves the surface exactly as closed as it was.'
	},
	{
		id: 'language',
		playful: true,
		name: 'Three language modes',
		group: 'Language',
		icon: 'language',
		site: 'shipped',
		app: 'shipped',
		...
		detail:
			'Bilingual holds English as the prominent primary and places Cantonese underneath as a compact secondary, rule-marked on long paragraphs so the two never read as one run-on. Localisation resources are kept separate from logic, and every mode is exercised at the longest strings and narrowest widths.',
		verify: 'Switch to Bilingual and check the longest labels at 320px width for clipping.'
	},
	{
		id: 'funny',
		playful: true,
		name: 'A funny level for each language',
		group: 'Language',
		icon: 'language',
		site: 'shipped',
		app: 'shipped',
		blurb:
			'Two independent sliders from 1, fully serious, to 5, maximum playfulness — one for English and one for Cantonese.',
		detail:
	...
	},
	{
		id: 'vocab',
		playful: true,
		name: 'Personal vocabulary upload',
		group: 'Language',
		icon: 'file',
		site: 'shipped',
		app: 'shipped',
		...
		verify:
			'Upload a malformed file and confirm nothing changes and the reason is named. Confirm an export states that vocabulary contents were omitted.'
	},
	{
		id: 'narrator',
		playful: true,
		name: 'Spoken narrator',
		group: 'Language',
		icon: 'bell',
		site: 'na',
		app: 'shipped',
		blurb:
			'Off by default, with a separate voice picker for each narrated language, plus rate and pitch.',
		detail:
		...
		verify:
			"Confirm the picker fills in after the platform's late enumeration rather than reporting no voices on a machine with forty."
	},
	{
		id: 'school',
		name: 'School mode',
		...
		verify:
			'Turn it on and confirm the hidden features produce no search results at all, not disabled ones.'
	},
	{
		id: 'schedule',
	...
	},
	{
		...
		verify:
			"Edit one element's appearance, reset that single property, and confirm neighbouring elements are untouched."
	},
	{
		id: 'colour',
		name: 'Infinite colour picker with translator',
		group: 'Appearance',
		icon: 'palette',
		site: 'na',
		app: 'shipped',
		...
		verify:
			'Enter an OKLCH value outside sRGB and confirm the clipping warning appears before it is applied.'
	},
	{
		id: 'logo',
		name: 'App logo customisation',
		group: 'Appearance',
		icon: 'image',
		site: 'na',
		app: 'shipped',
		blurb:
			'Several shipped presets plus a local image, with crop, fit, focal point and background.',
		detail:
		...
		verify:
			'Upload a file renamed to .png that is not a PNG and confirm it is rejected without partially applying.'
	},
	{
		id: 'rename',
		...
		verify:
			'Rename it, reload, and confirm your stored settings are still there under the original storage keys.'
	},
	{
		id: 'confirm',
		name: 'Destructive-action super confirmation',
		group: 'Safety',
		icon: 'shield',
		site: 'shipped',
		app: 'shipped',
		blurb:
			'Two independently operated keys, then a full-range slider, with an emergency exit always available.',
		detail:
			'The gate names the exact action and the exact data affected. Both keys must be set before the slider arms, and nothing happens until the slider completes. Escape cancels, focus returns to the control that opened it, and the safety facts stay unambiguous at every language and funny level.',
		verify: 'Try the slider with one key set and confirm it is inert.'
	},
	{
		id: 'notify',
		name: 'Non-blocking notifications with a reviewable centre',
		group: 'Safety',
		icon: 'bell',
		site: 'shipped',
		app: 'shipped',
		blurb:
			'Anything that only informs is a toast; a modal is reserved for a decision you must make.',
		detail:
	...
	{
		id: 'bulk',
		name: 'Bulk actions on every list',
		group: 'Data',
		icon: 'grid',
		site: 'shipped',
		app: 'shipped',
		blurb:
			'Multi-select, shift-click ranges, a select-all that states its scope, and inverse selection.',
		detail:
			'Not exempt for the notification centre or a history panel — those are lists too. Actions are offered in bulk rather than a token subset, the exact count and a reviewable preview are shown first, and anything skipped is reported rather than silently dropped.',
		verify:
			'Select every match of a filter, run a bulk action, and confirm the report distinguishes changed from skipped.'
	},
	{
		id: 'export',
		name: 'Export everything, in every format that fits',
		group: 'Data',
		icon: 'download',
		site: 'shipped',
		app: 'shipped',
		...
		verify:
			'Export the same data twice in two formats and confirm neither loses a field without saying so.'
	},
	{
		id: 'history',
		...
		verify:
			'Change a setting, restore it, then restore the restore, and confirm all three appear as separate entries.'
	},
	{
		id: 'changelog',
		...
		app: 'shipped',
		blurb:
			'Every released version in-product, filterable by date, searchable by pattern, each entry linking to its commit.',
		detail:
			'An entry that says what changed but not where is unverifiable, so every one carries the full commit SHA rendered as a short clickable reference. A wrong SHA is worse than none, so the build fails rather than emitting a dead link. A version with no recorded changes says so rather than being padded.',
	...
	},
	{
		...
		detail:
			'The log records what happened rather than what was expected to happen, which is the entire reason it is worth reading. It is a list, so it carries the same search, bulk actions and export as every other list.',
		verify: 'Perform an action and confirm the entry that appears describes what actually occurred.'
	},
	{
		id: 'dimsum',
		playful: true,
		name: 'Dim sum surprise',
		group: 'Delight',
		icon: 'image',
		site: 'shipped',
		app: 'shipped',
		...
		verify:
			'Confirm it never fires twice in one load, and that School mode removes it rather than hiding it.'
	},
	{
		id: 'a11y',
		name: 'Accessibility and responsive layout',
		group: 'Quality',
		icon: 'check',
		site: 'shipped',
		app: 'shipped',
		blurb:
			'Keyboard reachable end to end, screen-reader named, contrast-safe, and readable from 320px upward.',
		detail:
		...
		verify:
			'Tab through this page without touching the mouse and confirm every control is reachable and visibly focused.'
	},
	{
		id: 'buildscript',
		...
		verify:
			'Run it on a machine with no toolchain and confirm it completes without manual intervention.'
	},
	{
		id: 'nosign',
		name: 'Permanently unsigned releases',
		group: 'Quality',
		icon: 'warn',
		site: 'shipped',
		app: 'na',
		...
		detail:
			'The operating system will warn you about an unsigned installer. That warning is accurate and is not something to work around or dress up — it is stated plainly on the download surface rather than discovered afterwards.',
		verify: 'Confirm the warning text appears on the download surface before any release link.'
	},
	{
		id: 'free',
		name: 'Nothing is ever for sale',
		group: 'Quality',
		icon: 'check',
		site: 'shipped',
		app: 'shipped',
		...
		detail:
			"Every capability is available to everyone who runs it. This is not a pricing decision to revisit later. There are also no nagging prompts asking for donations, reviews, ratings or upgrades — where the product is built on somebody else's work, any funding link points at them and says so.",
		verify:
			'Search the interface for any purchase, upgrade or donation prompt; there should be none.'
	}
];
		...
		sections: [
			{
				...
				items: [
					{
						text: 'The Material Design 3 desktop application: frameless window, real window controls over IPC, and the token sheet shared with the documentation site so the two cannot drift apart.',
						sha: '324be60de'
					},
					{
						text: 'The Electron shell, with a narrow four-origin network allowlist and a backend probe that reports honestly when Python is absent.',
						sha: '58d546e2d'
					},
					{
						text: 'A command palette on Ctrl+Shift+F whose rows are live controls rather than labels, an export of everything, and the dim sum surprise.',
						sha: 'e6b77913d'
					},
					{
						text: 'Language modes, funny levels, the vocabulary contract, the spoken narrator with a voice picker per narrated language, and School mode — which omits rather than disables.',
						sha: 'd4fbc0337'
					},
					{
						text: 'Toy locks with a credential each, the support desk, and the unlock ladder that clears the waiting and never the credential.',
						sha: '5858e967c'
					},
					{
						text: 'QR pairing for the authenticator, encoded in this process from local code so no third-party service ever sees the secret.',
						sha: '0a681078c'
					},
					{
						text: 'A colour translator across every space the contract names, and a per-element appearance editor reachable from any context menu.',
						sha: '8af736fd7'
					},
					{
						text: 'The application mark: presets, a local image decided by its actual bytes, crop with a focal point, a maskable safe-area preview, and generated variants verified by signature.',
						sha: '3e6b1fd0c'
					},
					{
						text: 'Scheduled settings, with midnight crossings and both daylight-saving boundaries decided and documented rather than discovered.',
						sha: 'c57638c11'
					},
					{
						text: 'The tab system: docking to any edge, pinning, grouping, and the four discovery searches — all sharing one match predicate with the bulk closes.',
						sha: 'b459f5df5'
					},
					{
						text: 'Nine export formats, an append-only local history with a hash chain, and one bulk-action bar that states how much of a selection it cannot show you.',
						sha: 'a2bf591d2'
					}
				]
			},
			{
				...
				items: [
					{
						text: 'An apostrophe in a string made content.js invalid JavaScript and the live site served a blank page. A parse gate now runs first, locally and in CI.',
						sha: 'bcbf470b8'
					},
					{
						text: 'The QR format-information second copy was transposed, row for column. It passed every structural eye-test and every real scanner would have rejected it.',
						sha: '0a681078c'
					},
					{
						text: 'An icon-name guard was reporting green while matching nothing: a shell layer had collapsed an escape into a literal backspace character, so the pattern required an unprintable byte. No file this project writes may now contain a control character.',
						sha: '3e6b1fd0c'
					},
					{
						text: 'A bulk action opting out of the routine confirmation was also skipping the out-of-view warning, so it could reach items the dialog never mentioned.',
						sha: 'a2bf591d2'
					}
				]
			},
			{
				...
				items: [
					...
					{
						text: 'Every entry above names the commit it shipped in. An entry whose commit does not resolve is a build failure, not a documentation slip.',
						sha: null
					}
				]
			}
		...
		sections: [
			{
				...
				items: [
					{
						text: 'Forked Open WebUI and vendored the Material Design 3 design prototype under design/ as implementer reference.',
						sha: '9079c5fcd8b77065786435574a2c88391ed1cc6c'
					},
					{
						text: "Designed the landing page against the application's own token sheet — desktop, bilingual and phone views.",
						sha: '2b90041c6'
					},
					{
						text: 'Fixed the hero button row and sized the design artboard frames from measured renders rather than estimates.',
						sha: '4e4f92ae7'
					}
				]
			},
			{
				...
				items: [
					{
						text: 'No installer has been published. The desktop application is not built yet; this site documents what is designed and what is planned, and marks which is which.',
						sha: null
					}
				]
			}
